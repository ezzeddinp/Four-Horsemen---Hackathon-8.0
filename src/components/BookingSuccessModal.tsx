  ...
  return (
    ...
    >
      ...
      <View className="flex-1 bg-black/50 justify-center items-center px-6">
        {/* Modal Content */}
        <View className="bg-[#F2F0EF] rounded-[48px] w-full max-w-sm px-12 py-8 gap-8 items-center">
          {/* Success Icon */}
          <View className="w-[131px] h-[131px] bg-[#A78DF8] rounded-full items-center justify-center">
            <Ionicons name="checkmark" size={60} color="white" />
          </View>

          {/* Text Content */}
          <View className="gap-2 items-center">
            <Text className="text-[#1C2A3A] text-xl font-semibold text-center">
              Congratulations!
            </Text>
            <Text className="text-[#6B7280] text-sm text-center leading-[21px] max-w-[252px]">
              Your appointment with {appointmentDetails.doctor} is confirmed on{" "}
